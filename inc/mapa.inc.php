<div id="farmaciacercana" class="w-100">
    <div id="franjafarmacia" class="max-ysana">
        <h2><?php echo $lng[23]; ?></h2>
        <button type="button" class="btn btn-bg-color-2 b-white ml-3" data-toggle="modal" data-target="#modalFarmacia"><?php echo $lng[24]; ?></button>
    </div>
</div>
    <!-- Modal -->
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <?php echo $iM->get_input_text('frm_buscar', '', 'form-control', '', $lng[25], '', false, false, false, 'form-group mb-0 w-100'); ?>
                ...
                <div class="modal-body">
                    <!-- <div class="d-flex">
                        <?php echo $iM->get_input_text('frm_buscar', '', 'form-control', '', $lng[25]); ?>
                    </div> -->
    ...
    function buscarFarmacia(){
        consulta = $("#frm_buscar").val();
            $.ajax({
                ...
                dataType: "json",
                beforeSend: function(){
                    $("#listafarmacias").html('<div class="w-100 d-flex justify-content-center"><label><?php echo $lng[26]; ?>...</label></div>');
                }
            })
            ...
            .fail(function(){
                $("#listafarmacias").html('<div class="w-100 d-flex justify-content-center"><label><?php echo $lng[27]; ?></label></div>');
            });
    }
    buscarFarmacia();
    consulta = '';
